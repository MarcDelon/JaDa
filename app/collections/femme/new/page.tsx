  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Nouveautés Femme</h1>
          <p className="text-muted-foreground text-lg">Découvrez nos dernières arrivées</p>
        </div>

        {loading ? (
          <div className="text-center py-20">
            <p className="text-lg text-muted-foreground">Chargement des nouveautés...</p>
          </div>
        ) : newArrivals.length === 0 ? (
          <div className="text-center py-20">
            <p className="text-2xl font-semibold mb-2">Aucune nouveauté disponible</p>
            <p className="text-muted-foreground">Aucune nouveauté femme disponible pour le moment</p>
          </div>
        ) : (
