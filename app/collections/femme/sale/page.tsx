  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-accent">Soldes Femme</h1>
          <p className="text-muted-foreground text-lg">Profitez de réductions exceptionnelles</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-muted-foreground">Aucun produit femme en solde pour le moment</p>
          </div>
        ) : (
